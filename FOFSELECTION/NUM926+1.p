%------------------------------------------------------------------------------
% File     : NUM926+1 : TPTP v6.1.0. Released v5.3.0.
...
% Status   : Theorem
% Rating   : 0.36 v6.1.0, 0.27 v6.0.0, 0.30 v5.5.0, 0.41 v5.4.0, 0.46 v5.3.0
% Syntax   : Number of formulae    :  124 (  76 unit)
%            Number of atoms       :  183 (  87 equality)
...
%            Number of variables   :  244 (   0 sgn; 238   !;   6   ?)
