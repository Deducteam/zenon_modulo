%------------------------------------------------------------------------------
% File     : SEU294+3 : TPTP v6.1.0. Released v3.2.0.
% Domain   : Set theory
...
% Status   : Theorem
% Rating   : 0.04 v6.1.0, 0.07 v6.0.0, 0.04 v5.4.0, 0.07 v5.3.0, 0.11 v5.2.0, 0.00 v3.4.0, 0.05 v3.3.0, 0.00 v3.2.0
% Syntax   : Number of formulae    :   54 (   7 unit)
%            Number of atoms       :  172 (   2 equality)
