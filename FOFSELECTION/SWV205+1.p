%------------------------------------------------------------------------------
% File     : SWV205+1 : TPTP v6.1.0. Bugfixed v3.3.0.
...
% Status   : Theorem
% Rating   : 0.52 v6.1.0, 0.53 v6.0.0, 0.43 v5.5.0, 0.63 v5.4.0, 0.68 v5.3.0, 0.67 v5.2.0, 0.60 v5.1.0, 0.62 v5.0.0, 0.67 v4.1.0, 0.65 v4.0.1, 0.70 v4.0.0, 0.75 v3.7.0, 0.70 v3.5.0, 0.74 v3.4.0, 0.68 v3.3.0
% Syntax   : Number of formulae    :   92 (  56 unit)
%            Number of atoms       :  296 ( 110 equality)
%            Maximal formula depth :   36 (   4 average)
...
%            Number of variables   :  173 (   0 singleton; 173 !;   0 ?)
