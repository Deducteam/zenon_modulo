%------------------------------------------------------------------------------
% File     : CSR071+3 : TPTP v6.1.0. Released v3.4.0.
% Domain   : Common Sense Reasoning
% Problem  : Autogenerated Cyc Problem CSR071+3
% Version  : Especial.
% English  :
...
% Status   : Theorem
% Rating   : 0.27 v6.1.0, 0.24 v6.0.0, 0.25 v5.5.0, 0.42 v5.4.0, 0.39 v5.3.0, 0.43 v5.2.0, 0.36 v5.0.0, 0.35 v4.1.0, 0.39 v4.0.1, 0.37 v4.0.0, 0.40 v3.7.0, 0.14 v3.5.0, 0.00 v3.4.0
...
%            Number of variables   : 5970 (   0 singleton;5970 !;   0 ?)
