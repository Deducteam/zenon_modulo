%------------------------------------------------------------------------------
% File     : SWV099+1 : TPTP v6.1.0. Bugfixed v3.3.0.
...
% Status   : Theorem
% Rating   : 0.32 v6.1.0, 0.37 v6.0.0, 0.26 v5.5.0, 0.37 v5.4.0, 0.43 v5.3.0, 0.44 v5.2.0, 0.35 v5.1.0, 0.38 v5.0.0, 0.42 v4.1.0, 0.43 v4.0.0, 0.46 v3.7.0, 0.45 v3.5.0, 0.47 v3.4.0, 0.58 v3.3.0
% Syntax   : Number of formulae    :   92 (  56 unit)
%            Number of atoms       :  326 ( 138 equality)
...
%            Number of variables   :  172 (   0 singleton; 172 !;   0 ?)
