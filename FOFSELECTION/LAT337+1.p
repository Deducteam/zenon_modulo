%------------------------------------------------------------------------------
% File     : LAT337+1 : TPTP v6.1.0. Released v3.4.0.
...
% Status   : Theorem
% Rating   : 0.20 v6.1.0, 0.27 v6.0.0, 0.17 v5.5.0, 0.33 v5.4.0, 0.39 v5.3.0, 0.48 v5.2.0, 0.30 v5.1.0, 0.33 v5.0.0, 0.38 v4.1.0, 0.43 v4.0.0, 0.46 v3.7.0, 0.45 v3.5.0, 0.47 v3.4.0
% Syntax   : Number of formulae    :   83 (  19 unit)
%            Number of atoms       :  410 (   7 equality)
...
%            Number of variables   :  129 (   1 singleton; 102 !;  27 ?)
