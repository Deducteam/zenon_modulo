%------------------------------------------------------------------------------
% File     : GRP644+1 : TPTP v6.1.0. Released v3.4.0.
% Domain   : Group Theory
...
% Status   : Theorem
% Rating   : 0.16 v6.1.0, 0.13 v6.0.0, 0.17 v5.5.0, 0.11 v5.4.0, 0.18 v5.3.0, 0.22 v5.2.0, 0.10 v5.0.0, 0.17 v4.1.0, 0.22 v4.0.0, 0.25 v3.7.0, 0.20 v3.5.0, 0.21 v3.4.0
% Syntax   : Number of formulae    :   55 (  19 unit)
%            Number of atoms       :  167 (   6 equality)
...
%            Number of variables   :   94 (   1 singleton;  80 !;  14 ?)
