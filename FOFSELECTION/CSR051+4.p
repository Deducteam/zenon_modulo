%------------------------------------------------------------------------------
% File     : CSR051+4 : TPTP v6.1.0. Released v3.4.0.
% Domain   : Common Sense Reasoning
% Problem  : Autogenerated Cyc Problem CSR051+4
% Version  : Especial.
% English  :
...
% Status   : Theorem
% Rating   : 0.64 v6.1.0, 0.60 v6.0.0, 0.52 v5.5.0, 0.59 v5.4.0, 0.61 v5.3.0, 0.63 v5.2.0, 0.55 v5.1.0, 0.57 v5.0.0, 0.58 v4.1.0, 0.61 v4.0.1, 0.65 v4.0.0, 0.62 v3.7.0, 0.70 v3.5.0, 0.74 v3.4.0
...
%            Number of variables   : 24046 (   0 singleton;24045 !;   1 ?)
