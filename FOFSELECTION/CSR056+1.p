%------------------------------------------------------------------------------
% File     : CSR056+1 : TPTP v6.1.0. Released v3.4.0.
% Domain   : Common Sense Reasoning
% Problem  : Autogenerated Cyc Problem CSR056+1
% Version  : Especial.
% English  :
...
% Status   : Theorem
% Rating   : 0.00 v6.1.0, 0.04 v6.0.0, 0.50 v5.5.0, 0.17 v5.4.0, 0.22 v5.3.0, 0.26 v5.2.0, 0.07 v5.0.0, 0.10 v4.1.0, 0.06 v4.0.1, 0.00 v3.4.0
% Syntax   : Number of formulae    :   69 (  13 unit)
%            Number of atoms       :  139 (   0 equality)
%            Maximal formula depth :    7 (   4 average)
%            Number of connectives :   71 (   1 ~  ;   0  |;  15  &)
%                                         (   0 <=>;  55 =>;   0 <=)
%                                         (   0 <~>;   0 ~|;   0 ~&)
%            Number of predicates  :   21 (   0 propositional; 1-3 arity)
%            Number of functors    :   17 (  16 constant; 0-1 arity)
%            Number of variables   :  111 (   0 singleton; 110 !;   1 ?)
...
fof(query56,conjecture,(
    ? [QUANTITY] :
      ( mtvisible(c_tptp_member3717_mt)
     => tptpofobject(c_tptpartsupplies,QUANTITY) ) )).
