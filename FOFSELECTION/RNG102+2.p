%------------------------------------------------------------------------------
% File     : RNG102+2 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Ring Theory
...
% Status   : Theorem
% Rating   : 0.04 v6.1.0, 0.10 v6.0.0, 0.09 v5.5.0, 0.11 v5.4.0, 0.18 v5.3.0, 0.22 v5.2.0, 0.10 v5.1.0, 0.19 v5.0.0, 0.25 v4.1.0, 0.35 v4.0.1, 0.70 v4.0.0
% Syntax   : Number of formulae    :   41 (   4 unit)
...
%            Number of variables   :   86 (   0 singleton;  76 !;  10 ?)
