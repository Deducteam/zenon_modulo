%------------------------------------------------------------------------------
% File     : SWV093+1 : TPTP v6.1.0. Bugfixed v3.3.0.
...
% Status   : Theorem
% Rating   : 0.40 v6.1.0, 0.50 v6.0.0, 0.39 v5.5.0, 0.56 v5.4.0, 0.61 v5.3.0, 0.67 v5.2.0, 0.55 v5.1.0, 0.57 v5.0.0, 0.62 v4.1.0, 0.65 v4.0.0, 0.71 v3.7.0, 0.70 v3.5.0, 0.68 v3.4.0, 0.79 v3.3.0
% Syntax   : Number of formulae    :  102 (  65 unit)
%            Number of atoms       :  358 ( 150 equality)
%            Maximal formula depth :   40 (   4 average)
...
%            Number of variables   :  177 (   0 singleton; 177 !;   0 ?)
