%------------------------------------------------------------------------------
% File     : GRP653+1 : TPTP v6.1.0. Released v3.4.0.
% Domain   : Group Theory
...
% Status   : Theorem
% Rating   : 0.32 v6.1.0, 0.33 v6.0.0, 0.22 v5.5.0, 0.30 v5.4.0, 0.32 v5.3.0, 0.44 v5.2.0, 0.35 v5.1.0, 0.38 v4.1.0, 0.39 v4.0.0, 0.42 v3.7.0, 0.45 v3.5.0, 0.47 v3.4.0
% Syntax   : Number of formulae    :   66 (  20 unit)
%            Number of atoms       :  277 (   7 equality)
...
%            Number of variables   :  123 (   1 singleton; 103 !;  20 ?)
