%------------------------------------------------------------------------------
% File     : RNG106+1 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Ring Theory
...
% Status   : Theorem
% Rating   : 0.56 v6.1.0, 0.60 v6.0.0, 0.61 v5.5.0, 0.67 v5.4.0, 0.68 v5.3.0, 0.70 v5.2.0, 0.60 v5.1.0, 0.67 v5.0.0, 0.79 v4.1.0, 0.83 v4.0.1, 0.96 v4.0.0
% Syntax   : Number of formulae    :   39 (   4 unit)
%            Number of atoms       :  163 (  35 equality)
...
%            Number of variables   :   88 (   0 singleton;  79 !;   9 ?)
