%------------------------------------------------------------------------------
% File     : CSR046+4 : TPTP v6.1.0. Released v3.4.0.
% Domain   : Common Sense Reasoning
% Problem  : Autogenerated Cyc Problem CSR046+4
% Version  : Especial.
% English  :
...
% Status   : Theorem
% Rating   : 0.44 v6.1.0, 0.47 v6.0.0, 0.43 v5.5.0, 0.52 v5.4.0, 0.54 v5.3.0, 0.59 v5.2.0, 0.45 v5.1.0, 0.48 v5.0.0, 0.46 v4.1.0, 0.52 v4.0.0, 0.50 v3.7.0, 0.60 v3.5.0, 0.63 v3.4.0
