%------------------------------------------------------------------------------
% File     : NUM846+1 : TPTP v6.1.0. Released v4.1.0.
...
% Status   : Theorem
% Rating   : 0.24 v6.1.0, 0.23 v6.0.0, 0.26 v5.5.0, 0.19 v5.4.0, 0.18 v5.3.0, 0.26 v5.2.0, 0.10 v5.1.0, 0.14 v5.0.0, 0.17 v4.1.0
% Syntax   : Number of formulae    :   55 (  19 unit)
%            Number of atoms       :  105 (  49 equality)
