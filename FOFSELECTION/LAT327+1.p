%------------------------------------------------------------------------------
% File     : LAT327+1 : TPTP v6.1.0. Released v3.4.0.
...
% Status   : Theorem
% Rating   : 0.08 v6.1.0, 0.17 v6.0.0, 0.22 v5.5.0, 0.19 v5.4.0, 0.25 v5.3.0, 0.30 v5.2.0, 0.05 v5.1.0, 0.10 v5.0.0, 0.12 v4.1.0, 0.17 v4.0.0, 0.21 v3.7.0, 0.15 v3.5.0, 0.16 v3.4.0
% Syntax   : Number of formulae    :   43 (  15 unit)
%            Number of atoms       :  136 (   2 equality)
...
%            Number of variables   :   66 (   1 singleton;  53 !;  13 ?)
