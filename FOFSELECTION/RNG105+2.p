%------------------------------------------------------------------------------
% File     : RNG105+2 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Ring Theory
...
% Status   : Theorem
% Rating   : 0.24 v6.1.0, 0.30 v5.5.0, 0.37 v5.4.0, 0.43 v5.3.0, 0.44 v5.2.0, 0.35 v5.1.0, 0.48 v5.0.0, 0.54 v4.1.0, 0.57 v4.0.1, 0.83 v4.0.0
% Syntax   : Number of formulae    :   44 (   6 unit)
%            Number of atoms       :  170 (  39 equality)
...
%            Number of variables   :   87 (   0 singleton;  76 !;  11 ?)
