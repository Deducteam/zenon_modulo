%------------------------------------------------------------------------------
% File     : CSR033+2 : TPTP v6.1.0. Released v3.4.0.
% Domain   : Common Sense Reasoning
% Problem  : Autogenerated Cyc Problem CSR033+2
% Version  : Especial.
% English  :
...
% Status   : Theorem
% Rating   : 0.09 v6.1.0, 0.08 v6.0.0, 0.25 v5.5.0, 0.29 v5.4.0, 0.26 v5.3.0, 0.35 v5.2.0, 0.14 v5.0.0, 0.20 v4.1.0, 0.22 v4.0.1, 0.32 v4.0.0, 0.30 v3.7.0, 0.14 v3.5.0, 0.25 v3.4.0
% Syntax   : Number of formulae    : 1132 ( 346 unit)
%            Number of atoms       : 1967 (   0 equality)
