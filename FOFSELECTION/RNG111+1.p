%------------------------------------------------------------------------------
% File     : RNG111+1 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Ring Theory
...
% Status   : Theorem
% Rating   : 0.40 v6.1.0, 0.53 v6.0.0, 0.57 v5.5.0, 0.56 v5.4.0, 0.57 v5.3.0, 0.59 v5.2.0, 0.55 v5.1.0, 0.62 v5.0.0, 0.71 v4.1.0, 0.74 v4.0.1, 0.91 v4.0.0
% Syntax   : Number of formulae    :   45 (   4 unit)
%            Number of atoms       :  180 (  41 equality)
...
%            Number of variables   :   91 (   0 singleton;  81 !;  10 ?)
