%------------------------------------------------------------------------------
% File     : CSR047+4 : TPTP v6.1.0. Released v3.4.0.
% Domain   : Common Sense Reasoning
% Problem  : Autogenerated Cyc Problem CSR047+4
% Version  : Especial.
% English  :
...
% Status   : Theorem
% Rating   : 0.60 v6.1.0, 0.57 v6.0.0, 0.48 v5.5.0, 0.56 v5.4.0, 0.57 v5.3.0, 0.67 v5.2.0, 0.60 v5.1.0, 0.62 v4.1.0, 0.70 v4.0.1, 0.65 v4.0.0, 0.67 v3.7.0, 0.75 v3.5.0, 0.79 v3.4.0
