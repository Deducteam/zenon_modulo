%------------------------------------------------------------------------------
% File     : SEU374+1 : TPTP v6.1.0. Released v3.3.0.
% Domain   : Set theory
...
% Status   : Theorem
% Rating   : 0.16 v6.1.0, 0.20 v6.0.0, 0.22 v5.5.0, 0.15 v5.4.0, 0.21 v5.3.0, 0.22 v5.2.0, 0.10 v5.1.0, 0.14 v5.0.0, 0.25 v4.1.0, 0.30 v4.0.0, 0.33 v3.7.0, 0.25 v3.5.0, 0.26 v3.4.0, 0.37 v3.3.0
% Syntax   : Number of formulae    :   58 (  14 unit)
%            Number of atoms       :  150 (   8 equality)
...
%            Number of variables   :  105 (   1 singleton;  87 !;  18 ?)
