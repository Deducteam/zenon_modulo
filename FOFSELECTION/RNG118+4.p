%------------------------------------------------------------------------------
% File     : RNG118+4 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Ring Theory
...
% Status   : Theorem
% Rating   : 0.72 v6.1.0, 0.73 v6.0.0, 0.87 v5.5.0, 0.81 v5.4.0, 0.86 v5.3.0, 0.89 v5.2.0, 0.80 v5.1.0, 0.81 v5.0.0, 0.88 v4.1.0, 0.91 v4.0.0
% Syntax   : Number of formulae    :   50 (   3 unit)
%            Number of atoms       :  253 (  61 equality)
...
%            Number of variables   :  124 (   0 singleton;  87 !;  37 ?)
