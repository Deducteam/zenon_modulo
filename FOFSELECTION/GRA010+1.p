%--------------------------------------------------------------------------
% File     : GRA010+1 : TPTP v6.1.0. Bugfixed v3.2.0.
% Domain   : Graph Theory
...
% Status   : Theorem
% Rating   : 0.12 v6.1.0, 0.13 v6.0.0, 0.17 v5.5.0, 0.19 v5.4.0, 0.29 v5.3.0, 0.30 v5.2.0, 0.20 v5.1.0, 0.29 v5.0.0, 0.25 v4.1.0, 0.30 v4.0.1, 0.35 v4.0.0, 0.33 v3.7.0, 0.25 v3.5.0, 0.26 v3.4.0, 0.32 v3.3.0, 0.29 v3.2.0
...
%            Number of variables   :   71 (   0 singleton;  60 !;  11 ?)
