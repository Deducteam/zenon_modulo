%------------------------------------------------------------------------------
% File     : RNG112+4 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Ring Theory
...
% Status   : Theorem
% Rating   : 0.40 v6.1.0, 0.47 v6.0.0, 0.43 v5.5.0, 0.52 v5.4.0, 0.54 v5.3.0, 0.56 v5.2.0, 0.40 v5.1.0, 0.48 v5.0.0, 0.62 v4.1.0, 0.65 v4.0.1, 0.87 v4.0.0
% Syntax   : Number of formulae    :   46 (   3 unit)
%            Number of atoms       :  247 (  60 equality)
...
%            Number of variables   :  126 (   0 singleton;  89 !;  37 ?)
