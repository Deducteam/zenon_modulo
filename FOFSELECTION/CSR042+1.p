%------------------------------------------------------------------------------
% File     : CSR042+1 : TPTP v6.1.0. Released v3.4.0.
% Domain   : Common Sense Reasoning
% Problem  : Autogenerated Cyc Problem CSR042+1
% Version  : Especial.
% English  :
...
% Status   : Theorem
% Rating   : 0.00 v5.5.0, 0.22 v5.4.0, 0.11 v5.3.0, 0.09 v5.2.0, 0.00 v4.1.0, 0.06 v4.0.1, 0.00 v3.4.0
...
%            Number of variables   :   60 (   0 singleton;  59 !;   1 ?)
...
fof(query42,conjecture,(
    ? [ARG1] :
      ( mtvisible(c_tptpgeo_member7_mt)
     => borderson(ARG1,c_georegion_l4_x27_y64) ) )).
