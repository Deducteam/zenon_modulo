%------------------------------------------------------------------------------
% File     : RNG111+4 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Ring Theory
...
% Status   : Theorem
% Rating   : 0.48 v6.1.0, 0.60 v6.0.0, 0.57 v5.5.0, 0.63 v5.4.0, 0.64 v5.3.0, 0.67 v5.2.0, 0.55 v5.1.0, 0.62 v5.0.0, 0.71 v4.1.0, 0.78 v4.0.1, 0.96 v4.0.0
% Syntax   : Number of formulae    :   45 (   3 unit)
%            Number of atoms       :  253 (  62 equality)
...
%            Number of variables   :  129 (   0 singleton;  90 !;  39 ?)
