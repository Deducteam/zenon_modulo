%------------------------------------------------------------------------------
% File     : NUM427+1 : TPTP v6.1.0. Released v4.0.0.
...
% Status   : Theorem
% Rating   : 0.40 v6.1.0, 0.47 v6.0.0, 0.30 v5.5.0, 0.44 v5.4.0, 0.50 v5.3.0, 0.56 v5.2.0, 0.40 v5.1.0, 0.48 v5.0.0, 0.50 v4.1.0, 0.61 v4.0.1, 0.78 v4.0.0
% Syntax   : Number of formulae    :   25 (   5 unit)
%            Number of atoms       :   76 (  26 equality)
...
%            Number of variables   :   34 (   0 singleton;  33 !;   1 ?)
