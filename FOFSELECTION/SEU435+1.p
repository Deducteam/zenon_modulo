%------------------------------------------------------------------------------
% File     : SEU435+1 : TPTP v6.1.0. Released v3.4.0.
% Domain   : Set Theory
...
% Status   : Theorem
% Rating   : 0.12 v6.1.0, 0.17 v6.0.0, 0.13 v5.5.0, 0.15 v5.4.0, 0.21 v5.3.0, 0.26 v5.2.0, 0.15 v5.1.0, 0.19 v5.0.0, 0.17 v4.1.0, 0.22 v4.0.1, 0.26 v4.0.0, 0.29 v3.7.0, 0.20 v3.5.0, 0.21 v3.4.0
% Syntax   : Number of formulae    :   51 (  15 unit)
%            Number of atoms       :  108 (   8 equality)
...
%            Number of variables   :  112 (   1 singleton; 101 !;  11 ?)
