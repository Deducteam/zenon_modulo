%------------------------------------------------------------------------------
% File     : RNG125+4 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Ring Theory
...
% Status   : Theorem
% Rating   : 0.04 v6.1.0, 0.10 v6.0.0, 0.09 v5.5.0, 0.15 v5.4.0, 0.18 v5.3.0, 0.22 v5.2.0, 0.10 v5.1.0, 0.24 v5.0.0, 0.29 v4.1.0, 0.39 v4.0.1, 0.70 v4.0.0
% Syntax   : Number of formulae    :   50 (   4 unit)
...
%            Number of variables   :  122 (   0 singleton;  87 !;  35 ?)
