%------------------------------------------------------------------------------
% File     : CSR058+2 : TPTP v6.1.0. Released v3.4.0.
% Domain   : Common Sense Reasoning
% Problem  : Autogenerated Cyc Problem CSR058+2
% Version  : Especial.
% English  :
...
% Status   : Theorem
% Rating   : 0.09 v6.1.0, 0.04 v6.0.0, 0.25 v5.5.0, 0.12 v5.4.0, 0.17 v5.3.0, 0.22 v5.2.0, 0.14 v5.0.0, 0.15 v4.1.0, 0.17 v4.0.1, 0.21 v4.0.0, 0.20 v3.7.0, 0.00 v3.4.0
...
%            Number of variables   : 1122 (   0 singleton;1121 !;   1 ?)
